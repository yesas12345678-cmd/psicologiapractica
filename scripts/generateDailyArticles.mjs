...
if (!connectionString) {
  console.error("ERROR: No se ha encontrado la variable DATABASE_URL.");
  process.exit(1);
}
...
const CATEGORY_IMAGES = {
  "ansiedad-burnout": [
    ...
    "https://images.unsplash.com/photo-1512438248247-f0f2a5a8b7f0?w=800&auto=format&fit=crop&q=60", // Coffee cup and notebook
    "https://images.unsplash.com/photo-1489659639091-8b687bc4386e?w=800&auto=format&fit=crop&q=60", // Calm beach
    "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=800&auto=format&fit=crop&q=60", // Hand drawing a heart
    "https://images.unsplash.com/photo-1474418386616-3d234c28a96e?w=800&auto=format&fit=crop&q=60"  // Misty path
  ],
  "desarrollo-mindfulness": [
    ...
    "https://images.unsplash.com/photo-1508672019048-805c876b67e2?w=800&auto=format&fit=crop&q=60", // Writing outdoors
    "https://images.unsplash.com/photo-1490730141103-6cac27aaab94?w=800&auto=format&fit=crop&q=60", // Sunset horizon
    "https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=800&auto=format&fit=crop&q=60", // Green leaf, dew drops
    "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&auto=format&fit=crop&q=60"  // Mountain landscape
  ],
  "relaciones-entorno": [
    ...
    "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&auto=format&fit=crop&q=60", // People collaborating
    "https://images.unsplash.com/photo-1521791136368-1a8ac2749a1a?w=800&auto=format&fit=crop&q=60", // Handshake agreement
    "https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=800&auto=format&fit=crop&q=60", // Friends gather around fire
    "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&auto=format&fit=crop&q=60"  // Classmates talking
  ],
  "terapia-salud-mental": [
    ...
    "https://images.unsplash.com/photo-1473186578172-c141e6798cf4?w=800&auto=format&fit=crop&q=60", // Therapeutic consulting room
    "https://images.unsplash.com/photo-1544717305-2782549b5136?w=800&auto=format&fit=crop&q=60", // Therapy couch, book notes
    "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=800&auto=format&fit=crop&q=60", // Serenity, meditation
    "https://images.unsplash.com/photo-1489710437720-ebb67ec84dd2?w=800&auto=format&fit=crop&q=60", // Kid drawing, therapy development
    "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=800&auto=format&fit=crop&q=60", // Heart drawing symbol
    "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&auto=format&fit=crop&q=60", // Consultation trust
    "https://images.unsplash.com/photo-1584515906207-52c616682c65?w=800&auto=format&fit=crop&q=60"  // Deep listening session
  ]
};
